...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("vim_normal", "Vim normal", "start_goto_sequence", "Begin a goto sequence; pressing it again jumps to the top."),
    action("vim_normal", "Vim normal", "jump_bottom", "Move to the end of the text."),
    ...
    action("vim_normal", "Vim normal", "undo", "Undo the previous text edit."),
    action("vim_normal", "Vim normal", "redo", "Redo the previous undone text edit."),
    action("vim_normal", "Vim normal", "repeat_last_edit", "Repeat the previous Vim edit."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("vim_normal", "start_goto_sequence") => Some(&mut keymap.vim_normal.start_goto_sequence),
        ...
        ("vim_normal", "repeat_last_edit") => Some(&mut keymap.vim_normal.repeat_last_edit),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("vim_normal", "start_goto_sequence") => Some(runtime_keymap.vim_normal.start_goto_sequence.as_slice()),
        ("vim_normal", "jump_bottom") => Some(runtime_keymap.vim_normal.jump_bottom.as_slice()),
        ...
        ("vim_normal", "undo") => Some(runtime_keymap.vim_normal.undo.as_slice()),
        ("vim_normal", "redo") => Some(runtime_keymap.vim_normal.redo.as_slice()),
        ("vim_normal", "repeat_last_edit") => Some(runtime_keymap.vim_normal.repeat_last_edit.as_slice()),
