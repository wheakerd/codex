 ...
 */
durationMs: number | null, } | { "type": "fileChange", id: string, changes: Array<FileUpdateChange>, status: PatchApplyStatus, } | { "type": "mcpToolCall", id: string, server: string, tool: string, status: McpToolCallStatus, arguments: JsonValue, connectorId: string | null, mcpAppResourceUri?: string, mcpAppInvokedResourceUri: string | null, pluginId: string | null, result: McpToolCallResult | null, error: McpToolCallError | null,
/**
